"""Estado compartido entre servicios de operador y conductor.

Usa un JSON en runtime/dispatch_state.json para intercambiar:
- destino y decision clinica
- alertas/incidencias
- versionado para notificaciones de cambios
"""
